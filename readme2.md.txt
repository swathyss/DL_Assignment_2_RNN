...
* Missing data was either removed or imputed.
...
* Overfitting detection using validation data
...
✔ Sequence data preparation for RNN
✔ Building SimpleRNN models
✔ Model training and evaluation
✔ Forecasting future values using deep learning

---

# 📌 Academic Submission

This repository was created as part of a **Deep Learning assignment** to demonstrate the design, implementation, and evaluation of a **Recurrent Neural Network (RNN)** for time-series temperature prediction.
